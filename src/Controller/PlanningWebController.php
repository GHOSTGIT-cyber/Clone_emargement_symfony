...
class PlanningWebController extends AbstractController
{
    #[Route('/calendrier/events', name: 'web_planning_events', methods: ['GET'])]
    public function getEvents(Request $request, SessionRepository $sessionRepository): JsonResponse
    {
        $user = $this->getUser();
